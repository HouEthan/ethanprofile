...
export const profileContent: Record<Locale, ProfileContent> = {
  zh: {
    ...
    focusAreas: ["AI工具", "網際網路", "產品規劃", "個人品牌", "旅行與生活記錄"],
  ...
  ja: {
    location: "台湾・新竹",
    title: "AI 技術への関心と好奇心を持つソフトウェアエンジニア",
    intro: "ここは私の個人サイトで、プロジェクト、プロフィール、そして記録しておきたいグルメやスポットをまとめています。",
    about: [
      "取り組んできた仕事を、考え方や背景まで伝わる読みやすいストーリーとして整理するのが好きです。",
      "このサイトはプロフィール、プロジェクト、グルメ、スポットの四つを中心に構成していて、今後さらに広げられる余白も残しています。",
    ],
    focusAreas: ["AIツール", "インターネット", "プロダクト企画", "パーソナルブランディング", "旅と暮らしの記録"],
    skills: ["C#", "Kotlin", "WPF", "Dart", "HTML", "Python", "Java"],
    certifications: ["CEH"],
    experience: [
      "中原大学 情報管理学科",
      "中原大学 情報管理学修士",
      "Taiwan Mobile 第5期 T Ambassador 兼 サイバーセキュリティ実習生",
    ],
  },
};
